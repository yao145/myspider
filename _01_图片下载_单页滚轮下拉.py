...
class BeautifulPicture():
    ...
    def get_pic(self):
        ...
        print('开始获取所有img标签')
        all_a = BeautifulSoup(driver.page_source, 'lxml').find_all('img', class_='_2zEKz')  #获取网页中的class为cV68d的所有a标签
        print('开始创建文件夹')
